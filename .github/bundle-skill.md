---
name: bpost-e-MassPost Complete
...
This skill bundles all available e-MassPost skills. Use the routing guide below
to find the right knowledge for your task.
...
Do not try to load all content at once; use the index to find only what you need.
